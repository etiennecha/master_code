...
folder_prices = r'\data_gasoline\data_json_prices'

folders_period_prices = [r'\20110903_20120514_unl',
                         r'\20110904_20120514_lea',
                         r'\20120515_20120918_two',
                         r'\20120917_20121203_two',
                         r'\20130121-20130213_lea',
                         r'\20130121-20130213_unl']
...
def format_price_file_2011_unl(chemin):
  """
  Parses a txt file obtained from scraping and returns a list of dicts (dict =  gas station info)
  Each station dict has keys ['id_station', 'commune', 'nom_station', 'marque', 'prix', 'date']

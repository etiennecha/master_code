...
df_macro = pd.DataFrame(df_prices_ht.mean(1).values,
                        columns = [u'Average retail price'],
                        index = df_prices_ht.index)
df_macro['Brent'] = df_quotations['UFIP Brent R5 EL']
df_macro[u'Average retail price - Supermarkets'] = df_prices_ht[ls_sup_ids].mean(1)
df_macro[u'Average retail price - Others'] = df_prices_ht[ls_other_ids].mean(1)
# Column order determines legend
df_macro = df_macro[[u'Brent',
                     u'Average retail price',
                     u'Average retail price - Supermarkets',
                     u'Average retail price - Others']]

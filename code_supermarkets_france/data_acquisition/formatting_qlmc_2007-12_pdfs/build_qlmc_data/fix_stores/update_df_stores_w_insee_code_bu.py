...
df_stores.sort(['c_insee', 'period', 'store_municipality'], inplace = True)
se_insee_vc = df_stores['c_insee'].value_counts()
...
df_stores_all['c_qlmc_departement'] =\
  df_stores_all['c_qlmc_departement'].apply(lambda x: x.rjust(2,'0')\

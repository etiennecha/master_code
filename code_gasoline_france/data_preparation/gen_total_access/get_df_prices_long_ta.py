...
ls_df_lg_ttac = []
for id_station in ls_ta_chge_ids:
...
ls_df_lg_elfc = []
for id_station in ls_elf_ids:
  date_chge = df_info_ta.ix[id_station]['day_1']
  date_beg_nan = df_info_ta.ix[id_station]['day_1'] - pd.Timedelta(days = 10)
  date_end_nan = df_info_ta.ix[id_station]['day_1'] + pd.Timedelta(days = 10)

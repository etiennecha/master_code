...
print()
print(u'Representation of chains (source: LSA):')
...
print()
print(u'Representation by region:')
...
print()
print(u'Nb stores on website but not collected:', len(ls_not_collected_ids))
...
print()
print(u'Overview nb obs (products) by store:')
...
print()
print(u'Overview nb obs (products) by store / chain:')
chain_field = 'enseigne_qlmc'
...
print()
print(u'Overview nb obs (products) by qlmc comparison / chain:')

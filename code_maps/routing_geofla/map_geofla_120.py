...
#    xx, yy = zip(*shape)
#    if shape_dict['CLASS_ADM'] == u'Autoroute':
#      temp = m_fra.plot(xx, yy, linewidth = 3.5, color = 'r')
#      temp = m_fra.plot(xx, yy, linewidth = 2, color = '#ffff00')
#    elif shape_dict['CLASS_ADM'] == u'Nationale':
#      temp = m_fra.plot(xx, yy, linewidth = 3, color = 'k')
#      temp = m_fra.plot(xx, yy, linewidth = 2, color = 'r')
#    elif shape_dict['CLASS_ADM'] == u'Départementale':
#      temp = m_fra.plot(xx, yy, linewidth = 2.5, color = 'k')
#      temp = m_fra.plot(xx, yy, linewidth = 2.0, color = '#ffff00')
#    else:
#      temp = m_fra.plot(xx, yy, linewidth = 1.5, color = 'k')
#      temp = m_fra.plot(xx, yy, linewidth = 1.3, color = 'w')
#m_fra.drawcountries()
#m_fra.drawcoastlines()

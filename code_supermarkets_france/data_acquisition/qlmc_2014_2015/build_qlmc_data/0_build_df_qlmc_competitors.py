...
print(u'Nb pairs w/ distance above 30 km:', len(df_large_dist))
print(df_large_dist[ls_disp_dist].to_string())

print(u'Nb leclerc involved in large dist:',
      len(df_large_dist['lec_id'].unique()))

df_small_dist = df_qlmc_competitors[df_qlmc_competitors['dist'] <= 0.1]
print(u'Nb pairs w/ distance below 0.1 km:', len(df_small_dist))
...
df_qlmc_competitors.to_csv(os.path.join(path_built_csv, 'df_qlmc_competitors_201503.csv'),
                           encoding = 'utf-8',
                           float_format='%.3f',
                           index = False)

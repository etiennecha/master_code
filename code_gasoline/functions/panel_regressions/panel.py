...
from grouputils import Grouping
...
def test(y, X):
    ...
    # return out
    return [mod1, mod2, mod3, mod4, mod5, mod6]

if __name__=="__main__":
  from patsy import dmatrices
  #url = 'http://vincentarelbundock.github.com/Rdatasets/csv/plm/EmplUK.csv'
  #url = 'EmplUK.csv'
  url = r'\\ulysse\users\echamayou\Bureau\Etienne_work\Code\code_gasoline\code_gasoline_db_analysis\EmplUK.csv'

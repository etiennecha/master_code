...
Prices and brand changes were collected from the governmental comparison website on a daily basis between September 4, 2011 and December 4, 2014, hence a period of nearly 3 years. Over the period, 10,180 gas stations have posted price records, of which 437 were located on highways, 124 on the island of Corsica, and 402 were found to have insufficient or suspicious price data. The analysis was thus performed with a total number of 9,217 gas stations\footnote{Cf. appendix}. Table~\ref{tab:station_chains} provides an overview of gas station prices by chain on the last day of the studied period, December 04, 2014. The first column, "Type", classifies chains in three main categories: "Oil \& Independent" refers to chains operated by oil company gas stations or large intermediaries, "Oil discount" regroups two low price chains operated by oil companies, and "Supermarkets" contains gas stations which are operated by supermarket chains, generally next to a store.

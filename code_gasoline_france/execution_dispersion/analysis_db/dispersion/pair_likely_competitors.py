...
for id_station in ls_ids:
  ...
  df_closest_comp = df_station[df_station['group_last_1'] != df_station['group_last_2']].copy()
  ...
  df_temp = df_closest_comp # choose all (df_station) or competitors only (df_closest_comp)
  if len(df_temp) > 0:

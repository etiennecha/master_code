...
for ls_market_ids in dict_robust_markets[6]:
  ...
  for ls_gps_points, marker_c in [[ls_market_coordinates, 'b'],
                                  [ls_outside_coordinates, 'r']]:
  ...
  xmin, ymin = m(lng_ref - delta_lng, lat_ref - delta_lat)
  xmax, ymax = m(lng_ref + delta_lng, lat_ref + delta_lat)

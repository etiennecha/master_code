...
df_distances.to_csv(os.path.join(path_built_csv,
                                 'df_distances.csv'),
                    index_label = 'id_lsa',
                    float_format= '%.2f',
                    encoding = 'utf-8')

enc_json(ls_close_pairs, os.path.join(path_built_json,
                                      'ls_close_pairs.json'))

enc_json(dict_ls_close, os.path.join(path_built_json,
                                     'dict_ls_close.json'))

...
tree = ET.parse(os.path.join(path_data, 'data_osm', 'france_supermarket_ways.osm'))
root = tree.getroot()
...
#                urcrnrlon=x2)
#
#path_dir_geofla_com = os.path.join(path_data, 'data_maps', 'GEOFLA_COM_WGS84', 'COMMUNE')

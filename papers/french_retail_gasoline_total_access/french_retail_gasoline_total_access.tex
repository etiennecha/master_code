...
%\begin{center}
\includegraphics[width=\textwidth]{graphs/ta_macro_trends.png}
%\end{center}
\flushleft
...
\vspace{2eX} % If wanted space after the bottomrule
...
%\begin{center}
\includegraphics[width=\textwidth]{graphs/margin_change_detection.png}
%\end{center}
\flushleft
...
\hline
 ...
 & \textbf{Price}  & \textbf{Price}  & \textbf{Price}\\
 & \textbf{5 km}  & \textbf{3 km}  & \textbf{1 km}\\
\hline
\textbf{Total-Total Access}  & -9.89{*}{*}{*}  & -9.88{*}{*}{*}  & -9.87{*}{*}{*}\\
 & (0.17)  & (0.17)  & (0.16) \\
\textbf{Total SA gas stations}  & -0.17  & -0.19{*}  & -0.09\\
\textbf{close to Total-Total Access}  & (0.10)  & (0.10)  & (0.25)\\
\hline
\textbf{Elf-Total Access}  & -0.08{*}  & -0.08  & -0.07\\
 & (0.05)  & (0.05)  & (0.05) \\
\textbf{Total SA gas stations}  & 0.08  & -0.01  & -0.14 \\
\textbf{close to Elf-Total Access}  & (0.12)  & (0.13)  & (0.13) \\
\hline
\textbf{Intercept}  & 136.10{*}{*}{*}  & 135.81{*}{*}{*}  & 135.15{*}{*}{*} \\
 & (0.17)  & (0.17)  & (0.17) \\
\hline
\textbf{Nb. Obs.}  & 301.500  & 282.231  & 249.040 \\
\textbf{Adj. R2}  & 0.967  & 0.967  & 0.967 \\
\hline
\hline
\end{tabular}
%\end{footnotesize}
...
\parbox{\textwidth}{\footnotesize%
\vspace{2eX} % If wanted space after the bottomrule
{\footnotesize{}\uline{Reading note}}{\footnotesize{}: } Prices include VAT. Columns 1, 2 and 3 correspond to the following regression: $\mathrm{P}_{it}=\mathrm{\gamma}\cdot Treatment_{it}+\mathrm{\mu}_{i}+\mathrm{\eta}_{t,c}+\mathrm{\varepsilon}_{it}$ with $\mathrm{\eta}_{t,c}$ the temporal effects of a control group $c$, $\mathrm{\mu}_{i}$ gas station fixed effects, $\mathrm{\gamma}$ the effect of the rebranding ($Treatment_{it}$ is a dummy which takes value 1 after the rebranding). The control group includes gas stations within a 5 to 10 km distance from Total Access gas stations. Errors are clustered at the regional level. Significance thresholds: {*}{*}{*} 1\%, {*}{*} 5\%, {*} 10\%.}
\end{table}
...
\centering
\includegraphics[width=\textwidth]{graphs/price_dist_total_before.png}
\caption[short]{September 4, 2011}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
\centering
\includegraphics[width=\textwidth]{graphs/price_dist_total_after.png}
...
\parbox{\textwidth}{\footnotesize%
\vspace{2eX} % If wanted space after the bottomrule
{\footnotesize{}\uline{Reading Note}}{\footnotesize{}: } Columns 1 to 6 provide the results of the regression $\mathrm{P}_{it}=\mathrm{\gamma}\cdot Treatment_{it}+\mathrm{\mu}_{i}+\mathrm{\eta}_{t,c}+\mathrm{\varepsilon}_{it}$
with $\mathrm{\eta}_{t,c}$ temporal effects, function of a control group $c$, $\mathrm{\mu}_{i}$ gas station fixed effects, and $\mathrm{\gamma}$ the impact of a Total-Total Access or Elf-Total Access conversion on competitor prices (within a 1, 3 or 5 km distance). Treatment (equal to 1 after a nearby conversion has occurred) is crossed with retailer type in columns 2, 4 and 6. The control group is composed by gas stations located within 5 to 10 km of a Total- or Elf-Total Access gas station. Error terms are clustered at the regional level. Significance thresholds {*}{*}{*} 1\%, {*}{*} 5\%, {*} 10\%.}
\end{table}
...
\begin{subfigure}{.49\textwidth}
\centering
\includegraphics[width=\textwidth]{graphs/price_dist_treated_before.png}
\caption[short]{September 4, 2011}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
\centering
\includegraphics[width=\textwidth]{graphs/price_dist_treated_after.png}
\caption[short]{December 4, 2014}
\end{subfigure}
\flushleft
...
\centering
\includegraphics[width=\textwidth]{graphs/reaction_agip_increases_big.png}
\caption[short]{Price increase}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
\centering
\includegraphics[width=\textwidth]{graphs/reaction_esso_matches_decrease.png}

...
df_stores = df_qlmc[['id_lsa',
                     'store_name',
                     'store_chain']].drop_duplicates()
...
df_close_pairs.to_csv(os.path.join(path_built_201415_csv,
...
df_same_pairs.to_csv(os.path.join(path_built_201415_csv,

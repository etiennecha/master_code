...
list_match = [[[u'SYSTEME U', u'BARALLE MARQUION'], ['BARALLE', '62860', 'PAS DE CALAIS', '62081']],
...
enc_json(list_match, path_data + folder_source_qlmc_json + r'/other/list_city_match')
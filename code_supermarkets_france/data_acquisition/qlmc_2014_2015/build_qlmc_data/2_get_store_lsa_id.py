...
print()
print('Nb no id_lsa:', len(df_matching[df_matching['id_lsa'].isnull()]))
...
print()
print('Distance > 5 km')
print(df_stores_f[df_stores_f['dist'] > 5][ls_di + ['dist', 'Q']].to_string())
# todo: extend to 3
...
#print()
#print(df_stores_f[(df_stores_f['verif'] == 1) &

...
ls_ls_competitors_nd = []
for indiv_id, ls_comp in zip(master_price['ids'],
                             ls_ls_competitors):
  ls_comp_nd = []
  ...
  ls_ls_competitors_nd.append(ls_comp_nd)

ls_no_info = []
ls_no_comp = []
ls_no_comp_nd = []
for indiv_id, ls_comp, ls_comp_nd in zip(master_price['ids'],
                                         ls_ls_competitors,
                                         ls_ls_competitors_nd):
  if ls_comp == None:
...
dict_comp_nd = dict(zip(master_price['ids'], ls_ls_competitors_nd))

# TODO: case study with Amberieu en bugey

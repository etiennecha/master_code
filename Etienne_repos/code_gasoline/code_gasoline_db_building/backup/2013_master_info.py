...
folder_info_stations = r'\data_gasoline\data_stations\data_info_stations_prix_carb'
folder_gps_coordinates = r'\data_gasoline\data_stations\data_stations_coordinates'
...
for file in raw_data_files:
  raw_data_info.append(dec_json(path_data + folder_info_stations + file))
...
gps_lea = dec_json(path_data + folder_gps_coordinates + r'\20130117_list_coordinates_diesel')
gps_master = format_gps_coordinates(gps_lea)
gps_unl = dec_json(path_data + folder_gps_coordinates + r'\\20130117_list_coordinates_essence')

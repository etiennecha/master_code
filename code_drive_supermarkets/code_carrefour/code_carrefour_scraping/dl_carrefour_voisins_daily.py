...
post_args = {'id' : 'drivePickingForm_290',
             'name' : 'drivePickingForm_290'}
...
enc_stock_json(master_products, path_data + folder_source_carrefour_voisins_prices + r'\20%s_carrefour_voisins' %today_date)

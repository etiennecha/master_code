...
for dpt in df_treated_comp['dpt'].unique():
  ...
  for id_station, row_station in df_dpt_treated_comp.iterrows():
    ...
    if row_station['id_ta_0'] in ls_ta_chge_ids:
      date_beg = df_info_ta.ix[row_station['id_ta_0']]['date_beg']
      date_end = df_info_ta.ix[row_station['id_ta_0']]['date_end']
    else:
      date_beg = df_info_ta.ix[row_station['id_ta_1']]['date_beg']
      date_end = df_info_ta.ix[row_station['id_ta_1']]['date_end']

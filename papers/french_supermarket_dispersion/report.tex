...
\section{Chain price policies}

\begin{table}[H]
\renewcommand{\arraystretch}{0.7}% Tighter
\caption{Distribution of the frequencies of the most common price per product}\label{tab:qlmc_prod_freq_50}
\small
...
SUPER U            & 1,077 &  0.39 & 0.12 & 0.09 & 0.32 & 0.37 & 0.44 & 0.91 \\
\bottomrule
\bottomrule
...
SUPER U           & 409 &  0.08 & 0.05 & 0.00 & 0.04 & 0.06 & 0.12 & 0.17 \\
\bottomrule
\bottomrule
\multicolumn{9}{p{0.8\textwidth}}{\footnotesize Reading note: A price is considered "standard" if it is shared by 50\% of the chain stores or more. On average, a Leclerc store sells 28\% of its products at a "standard" price.}
\end{tabular}
\end{table}

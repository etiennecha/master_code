...
#
#print df_elf_res_tr_sg.describe(percentiles = [0.1, 0.25, 0.5, 0.75, 0.9])
#
## Merge with station details
#df_elf_res_tr_sg['id_station'] = df_elf_res_tr_sg['name'].apply(lambda x: x[3:])
#df_elf_res_tr_sg.set_index('id_station', inplace = True)
#df_elf_comp_details = pd.DataFrame(ls_rows_elf_comp_details,
#                                   columns = ['id_station', 'group_type', 'id_ta', 'distance'])
#df_elf_comp_details.set_index('id_station', inplace = True)
#
#df_elf_comp_final = pd.merge(df_elf_res_tr_sg,
#                             df_elf_comp_details,
#                             left_index = True,
#                             right_index = True,
#                             how = 'left')

...
## ###################
#
#ls_keep_comp = list(df_info[df_info['highway'] != 1].index)
...
# STATS DES  
print u'\nTotal-TA: Stats des: Departement, Nb Total-TA comp, Nb controls'
c_control_pbm = 0
for i in range(0,96):
	nb_tta_comp = len(df_tta_comp[df_tta_comp['dpt'] == '{:02d}'.format(i)])
	nb_control = len(df_control_comp[df_control_comp['dpt'] == '{:02d}'.format(i)])
	if nb_tta_comp != 0:
		print '{:2d}'.format(i), '{:02d}'.format(nb_tta_comp), nb_control
		if nb_control < 5:
			c_control_pbm += 1
...
c_control_pbm = 0
for i in range(0,96):
	nb_elf_comp = len(df_elf_comp[df_elf_comp['dpt'] == '{:02d}'.format(i)])
	nb_control = len(df_control_comp[df_control_comp['dpt'] == '{:02d}'.format(i)])
	if nb_elf_comp != 0:
...
## GRAPH (TOTAL COMP)
#
#ax = df_tta_comp_final[df_tta_comp_final['group_type'] == 'SUP']\
#       .plot(kind = 'scatter',
#             x = 'distance',
#             y = 'coeff',
#             color = 'r',
#             label = 'SUPERMARKETS')
#
#df_tta_comp_final[df_tta_comp_final['group_type'] != 'SUP']\
#  .plot(kind = 'scatter',
#        x = 'distance',
#        y = 'coeff',
#        ax = ax,
...
## GRAPH (ELF COMP)
#
#ax = df_elf_comp_final[df_elf_comp_final['group_type'] == 'SUP']\
#       .plot(kind = 'scatter',
#             x = 'distance',
#             y = 'coeff',
#             color = 'r',
#             label = 'SUPERMARKETS')
#
#df_elf_comp_final[df_elf_comp_final['group_type'] != 'SUP']\
#  .plot(kind = 'scatter',
#        x = 'distance',
#        y = 'coeff',
#        ax = ax,
